...
func dataSourceSslAdminCaList() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceSslAdminCaListRead,
...
func dataSourceSslAdminCaListRead(d *schema.ResourceData, tm interface{}) error {
	objectList, err := tm.(*vtm.VirtualTrafficManager).ListSslAdminCas()
	if err != nil {
		d.SetId("")
		return fmt.Errorf("Failed to read vtm_ssl_admin_ca_list: %v", err.ErrorText)
	}

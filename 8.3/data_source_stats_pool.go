...
func dataSourcePoolStatistics() *schema.Resource {
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			// Maximum time, measured in milliseconds, for which a connection
			//  was queued over the last second.
			"max_queue_time": &schema.Schema{
				Type:     schema.TypeInt,
				Optional: true,
			},

			// Mean time, measured in milliseconds, for which a connection was
			//  queued over the last second.
			"mean_queue_time": &schema.Schema{
				Type:     schema.TypeInt,
				Optional: true,
			},

			// Minimum time, measured in milliseconds, for which a connection
			//  was queued over the last second.

...
func getResourceGlobalSettingsSchema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"max_tcp_buff_mem": &schema.Schema{
			Type:     schema.TypeString,
			Optional: true,
			Default:  "0",
		},
		...
		//  set to 'Yes'.
		"connection_udp_read_multiple": &schema.Schema{
			Type:     schema.TypeBool,
			Optional: true,
			Default:  true,
		},
...
func resourceGlobalSettingsRead(d *schema.ResourceData, tm interface{}) (readError error) {
	...
	lastAssignedField = "max_tcp_buff_mem"
	d.Set("max_tcp_buff_mem", string(*object.Basic.MaxTcpBuffMem))
	...
	lastAssignedField = "connection_udp_read_multiple"
	d.Set("connection_udp_read_multiple", bool(*object.Connection.UdpReadMultiple))
...
func resourceGlobalSettingsUpdate(d *schema.ResourceData, tm interface{}) error {
	...
	setString(&object.Basic.MaxTcpBuffMem, d, "max_tcp_buff_mem")
	...
	setBool(&object.Connection.UdpReadMultiple, d, "connection_udp_read_multiple")

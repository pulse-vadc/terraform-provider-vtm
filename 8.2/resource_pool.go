...
func getResourcePoolSchema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"connection_max_transactions_per_node": &schema.Schema{
			Type:         schema.TypeInt,
			Optional:     true,
			ValidateFunc: validation.IntBetween(0, 999999),
			Default:      0,
		...
		"ssl_ssl_fixed_client_certificate": &schema.Schema{
			Type:     schema.TypeString,
			Optional: true,
		},
...
func resourcePoolRead(d *schema.ResourceData, tm interface{}) (readError error) {
	...
	lastAssignedField = "connection_max_transactions_per_node"
	d.Set("connection_max_transactions_per_node", int(*object.Connection.MaxTransactionsPerNode))
	...
	d.Set("ssl_middlebox_compatibility", string(*object.Ssl.MiddleboxCompatibility))
	...
	lastAssignedField = "ssl_ssl_fixed_client_certificate"
	d.Set("ssl_ssl_fixed_client_certificate", string(*object.Ssl.SslFixedClientCertificate))
...
func resourcePoolObjectFieldAssignments(d *schema.ResourceData, object *vtm.Pool) {
	...
	setInt(&object.Connection.MaxTransactionsPerNode, d, "connection_max_transactions_per_node")
	...
	setString(&object.Ssl.MiddleboxCompatibility, d, "ssl_middlebox_compatibility")
	...
	setString(&object.Ssl.SslFixedClientCertificate, d, "ssl_ssl_fixed_client_certificate")

...
func getResourceTrafficManagerSchema() map[string]*schema.Schema {
	return map[string]*schema.Schema{
		...
		"admin_hsts_enable": &schema.Schema{
...
func resourceTrafficManagerRead(d *schema.ResourceData, tm interface{}) (readError error) {
	...
	lastAssignedField = "admin_hsts_enable"
	d.Set("admin_hsts_enable", bool(*object.Admin.HstsEnable))
	lastAssignedField = "admin_hsts_max_age"
	d.Set("admin_hsts_max_age", int(*object.Admin.HstsMaxAge))
...
func resourceTrafficManagerObjectFieldAssignments(d *schema.ResourceData, object *vtm.TrafficManager) {
	...
	setBool(&object.Admin.HstsEnable, d, "admin_hsts_enable")
	setInt(&object.Admin.HstsMaxAge, d, "admin_hsts_max_age")
